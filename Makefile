...
bin/geometry.exe: build/main.o build/circle_intersects.o build/printCircle.o build/printPoligon.o build/printTriangle.o build/proverka.o build/proverka_perecech_otrezkov.o build/input_data.o build/areCollinear.o build/getMin.o build/getMax.o build/prijectionsIntersect.o build/getSlope.o build/getYIntercept.o build/getCos.o build/testing.o build/perpendicular.o build/distan.o build/prov_data.o build/print_posle_prov.o
...
build/proverka_perecech_otrezkov.o: src/perecechotrezkov.c src/geometry.h
	$(OBJ)
...
build/prijectionsIntersect.o: src/prijectionsIntersect.c src/geometry.h
	$(OBJ)
